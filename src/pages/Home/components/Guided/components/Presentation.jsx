...
export default Presentation = () => {
  return (
    <section className="relative py-44 px-4 overflow-hidden" style={{ backgroundColor: '#F0E6DD' }}>
      <div className="max-w-4xl mx-auto relative z-10">
        <h2 className="text-4xl md:text-5xl font-bold mb-6 text-center tracking-widest font-bangers" style={{ color: '#2f2f27' }}>
          GUIDED LEARNING
        </h2>
        <div className="space-y-6 mb-20 text-lg" style={{ color: '#2f2f27' }}>
          ...
          <br />
          În Learnity profesorii sunt egali cu elevii, nu există teme impuse sau activități obligatorii, iar materia este predată într-un mod cât mai practic și atractiv.
          Learnitașii pot oferi oricând “feedback” profesorilor și pot alege să participe doar la experiențele pe care le consideră valoroase pentru ei.
          </p>
        </div>
